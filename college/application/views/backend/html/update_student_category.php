            	...
            	<table class="table responsive table-bordered table-striped">
                    ...
                    <thead>
                        <tr>
                          ...
                          <form id="" action="http://localhost/school/index.php/backend/dashboard/update/" method="post">
                           <div class="student_txt"> <input type="text" name="category" value="<?php echo $result['name'] ?>" required placeholder="Category" /></div>
						   <input name="id" type="hidden" value="<?php echo $result['id']; ?>" />
                           <div class="student_submit"><button type="submit" name="submit" class="btn btn-info" >Save</button></div>
                           </form>
                           </div>
            	...
            	<table class="table table-striped">
					...
					//foreach($result as $val){?>
                        <tr>
                           ...
                           <td><a href="http://localhost/school/index.php/backend/dashboard/update/<?php echo $result['id']; ?>"><i class="icon-pencil" title="Edit"></i></a>
						   <a href="http://localhost/school/index.php/backend/dashboard/delete/<?php echo $result['id']; ?>"><i class="icon-trash" title="Delete"></i></a></td>
                        </tr>
                     <?php //}?>
